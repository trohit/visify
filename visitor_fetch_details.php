 ...
 */
	...
	$result=mysql_query("SELECT (visitor.vid),vrecordid,vname,vitime,vtomeet,vblock,vflatnum,vvehicle_type,vvehicle_reg_num,vpurpose,vcomments FROM visitor,vrecord WHERE vrecord.vid=visitor.vid AND visitor.vphone='$phone_num' ORDER BY vrecordid DESC LIMIT $num_limit");
...
$num_limit = htmlspecialchars(strip_tags($_REQUEST['num_limit']));
