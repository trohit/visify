...
$(document).ready(function() {
	$('#hint_visitor_pic').click(function() {
		//alert("was clicked");
...
<script type="text/javascript" src="block_insert.js"></script>
...
//echo "disping image\n";
///Just to disp a pic
if (strlen($_REQUEST['picinfo_hidden'])) {
	$imgstr = $_REQUEST['picinfo_hidden'];

	$img_data = str_replace('data:image/png;base64,', '', $imgstr);
	$img = str_replace(' ', '+', $img_data);
	//$data = base64_decode($img);
	//echo $data;
	echo '<img src="data:image/png;base64,' . $img . '" />';
	file_put_contents('/tmp/image.png', $img_data);
	file_put_contents('/tmp/image2.png', $img);
	...
	file_put_contents('/tmp/image3.png', $data);
...
-->
   <tr>
     <td> <label class="description" for="element_10"> <img src="images/contact.jpg"/> Visitor Mobile Num <font color="red">*</font></label></td>
     <td> <label class="description" for="element_1"><img src="images/person.jpg"/> Visitor Name <font color="red">*</font> </label> </td>
     <td> <label class="description" for="element_2"><img src="images/num_ppl.png"/> Headcount <font color="red">*</font> </label> </td>
   </tr>
   <tr>
     <td> <input id="phone_num" name="phone_num" type="text" class="element text medium" autofocus data-trigger="keyup"  data-type="digits" data-rangelength="[10,10]" data-required="true" title="phone consist of 10 numeric characters." <?php echo (isset($vphone))?('value="'.$vphone.'"'):""; ?>/>
<!--
<img id="searchnum" onclick="$('#phone_num').trigger('change');" style="vertical-align: middle"; src="images/search-icon.png" alt="load" height="24" title="Load Details"/>
<button onclick="$('#phone_num').trigger('change');">Load something</button>
-->
    </td>
<!--
...
-->
     <td> <input id="name" name="name" onclick="$('#phone_num').trigger('change');" type="text" maxlength="32" value="" class="element text large"  placeholder="FirstName LastName" style="text-transform:capitalize" style="whitespace:nowrap" data-regexp="^[A-Za-z ]+$" data-required="true"/> </td>
...
-->
     <td> 
	<div id="hint_visitor_pic" align="right">
<?php
if (strlen($_REQUEST['picinfo_hidden'])) {
	echo '<img src="data:image/png;base64,' . $img . '" />';
} else {
	echo '<img src="images/missing.jpg" height="144"/>';
}
?>
	</div> 
     </td>
...
<table border="0" width="100%" style='display:inline'>
   <tr id="txt_display_vehicle_labels" style='display:none'>
     <td> <label class="description" for="element_10"> Additional Details</label></td>
...
-->
   ...
   <tr>
     <td> <input class="description" type="checkbox" name="isVehicleSelected" id="isVehicleSelected" onclick="showVehicleinfo()" value="vehicle">Add Vehicle</td>
...
<!-- Begin Owners details-->
		<div>
			<li id="li_10" >
			<label class="description" for="element_6">  <img src="images/tomeet_icon.jpg" width="32" height="32"/>Name of Resident / Block Name / Flat Number <font color="red">*</font></label>
			...
			<label class="description" id="label_block_other" style='display:none'>Specify where exactly<font color="red">*</font>:</label>
...
<img id="top" src="images/top.png" alt="">
		<div>
			<li id="li_11" >
			<label class="description" for="element_7">Purpose <font color="red">*</font></label>
<!--
